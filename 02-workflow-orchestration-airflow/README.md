...
- If you run into a permission issue when running pip install in your Dockerfile, it might be because the default user which is "airflow" does not have the permission to do so. Switch to user "root" and pip install and switch back to "airflow"
