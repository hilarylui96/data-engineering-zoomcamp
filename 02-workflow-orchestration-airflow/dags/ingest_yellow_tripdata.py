...
import pandas as pd
from utilities.yellow_queries import (create_tripdata_table, create_tripdata_external_table, 
...
with DAG ( 
  ...
  download_data_task = BashOperator(
    ...
    bash_command=f"""
      wget -qO- https://github.com/DataTalksClub/nyc-tlc-data/releases/download/yellow/{file_name_base}.csv.gz \
